<h4>Chatbot WhatsApp: Integrasi Whatsapp API & Google Gemini AI</h1>
...
Akun Fonnte: Memiliki akun aktif di fonnte.com dan perangkat (device) yang sudah berstatus Connected.
Google Gemini API Key: Token API yang bisa didapatkan secara gratis melalui Google AI Studio.
